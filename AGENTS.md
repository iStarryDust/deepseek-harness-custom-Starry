...
- **Agents are identity, modes are chat-time choices**: combined presets (`<agentId>-<modeId>`) own chat capability; see [`ui-agents`](packages/client/ui-agents/README.md) and [`ui-agent-preset`](packages/client/ui-agent-preset/README.md).
