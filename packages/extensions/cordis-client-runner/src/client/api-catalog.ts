...
export const SERVICE_API: readonly ServiceApiEntry[] = [
  ...
  },
  {
    ...
    methods: [
      ...
      {
        signature: 'fork(opts: { sessionId: SessionId; atSeq?: number; beforeTurnAtSeq?: number; increaseTitle?: boolean }): Promise<SessionId>',
        ...
        parameters: [{ name: 'opts', description: 'source session id, the optional event seq anchoring the cut (the boundary is the first turn/end at or after it; an in-log anchor in an open turn is unavailable rather than clipped backward), the optional event seq whose containing turn the host cuts before (resolved from the full log when the client window lacks the turn), and whether to increment an inherited durable title before resolving.' }],
