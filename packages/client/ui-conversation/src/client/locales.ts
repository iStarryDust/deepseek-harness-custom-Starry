...
export const zh = {
  ...
  'message.edit': '修改这条消息',
  'message.edit.unavailable': '智能体运行中，暂不能修改',
  'message.edit.unavailable.window': '该消息所在轮次已不在当前窗口（上下文已压缩），无法修改',
  'message.edit.save': '重新生成',
  'message.edit.cancel': '取消',
  'message.edit.hint': '将从此条消息重新生成，它之后的内容不会保留',
  'message.edit.failed': '修改失败：{reason}',
  'message.edit.image.add': '添加图片',
  'message.edit.image.remove': '移除这张图片',
...
export const en = {
  ...
  'message.edit': 'Edit this message',
  'message.edit.unavailable': 'Unavailable while the agent is running',
  'message.edit.unavailable.window': 'The turn containing this message is no longer in the loaded window (context compacted)',
  'message.edit.save': 'Regenerate',
  'message.edit.cancel': 'Cancel',
  'message.edit.hint': 'Regenerates from this message; later content will not be kept',
  'message.edit.failed': 'Edit failed: {reason}',
  'message.edit.image.add': 'Add images',
  'message.edit.image.remove': 'Remove this image',
