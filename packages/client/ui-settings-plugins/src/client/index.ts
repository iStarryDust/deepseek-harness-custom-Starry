...
import { BROWSER_NS, BrowserCardController, type BrowserHostApi } from './browser-card-controller.ts'
...
export function apply(ctx: ClientContext): void {
  ...
  const browserCard = new BrowserCardController(
    ctx.settingsScope.bind({ namespace: BROWSER_NS }),
    api as unknown as BrowserHostApi,
  )
