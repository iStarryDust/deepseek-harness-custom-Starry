...
export interface RpcMethodMap {
  ...
  'session.remove': SessionsApi['remove']
  ...
  'host.browserProbe': HostApi['browserProbe']
  'host.browserInstall': HostApi['browserInstall']
  ...
  'agentPreset.capabilities': AgentPresetsApi['capabilities']
  'agentPreset.composeEnvironment': AgentPresetsApi['composeEnvironment']
  'agentPreset.suggestEnvironment': AgentPresetsApi['suggestEnvironment']
