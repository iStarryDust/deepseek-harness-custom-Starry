...
import {
  hostBrowserInstallValueSchema, hostBrowserProbeValueSchema,
...
export interface IApiClient {
  ...
  host: {
    ...
    browserProbe(payload: RequestPayload<'host.browserProbe'>, signal?: AbortSignal): Promise<RpcResponse<ResponseValue<'host.browserProbe'>>>
    browserInstall(payload: RequestPayload<'host.browserInstall'>, signal?: AbortSignal): Promise<RpcResponse<ResponseValue<'host.browserInstall'>>>
  }
  workspace: {
...
const UNARY_VALUE_SCHEMAS: { [K in keyof RpcMethodMap]: z.ZodType<Wire<ResponseValue<K>>> } = {
  ...
  'host.browserProbe': hostBrowserProbeValueSchema,
  'host.browserInstall': hostBrowserInstallValueSchema,
...
export abstract class AbstractApiClient implements IApiClient {
  ...
  readonly host: IApiClient['host'] = {
    ...
    browserProbe: (payload, signal) => this.callUnary('host.browserProbe', payload, signal),
    browserInstall: (payload, signal) => this.callUnary('host.browserInstall', payload, signal),
  }
